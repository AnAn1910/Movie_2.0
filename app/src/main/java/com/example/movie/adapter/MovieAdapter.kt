...
class MovieAdapter(private val listMovies: MutableList<Movie?>?, private var mActivity: Activity?,
                   private val iClickItemListener: IClickItemListener?) : RecyclerView.Adapter<MovieAdapter.MovieViewHolder?>() {
